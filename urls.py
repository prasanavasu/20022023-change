...
app.add_url_rule("/login", methods=["POST"], view_func=home.login)

app.add_url_rule("/create_parent/<pk>", methods=["POST"], view_func=home.create_parent)

app.add_url_rule("/create_child/<pk>", methods=["POST"], view_func=home.create_child)
